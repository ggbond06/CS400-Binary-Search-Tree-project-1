...
public class BinarySearchTree<T extends Comparable<T>> implements SortedCollection<T> {
    ...
    */
     ...
     * @param subtree the root node of the subtree where the newNode should be inserted
     */
    ...
    */
     ...
     * this also checks for the structure of the tree
    ...
    */
    public boolean test1() {
        ...
        if (tree.root == null || !tree.root.getData().equals(20)) {
            return false;
        }

        if (tree.root.getLeft() == null || !tree.root.getLeft().getData().equals(10)) {
            return false;
        }
        if (tree.root.getRight() == null || !tree.root.getRight().getData().equals(30)) {
            return false;
        }

        if (tree.root.getLeft().getLeft() == null || !tree.root.getLeft().getLeft().getData().equals(5)) {
            return false;
        }
        if (tree.root.getLeft().getLeft().getLeft() == null || !tree.root.getLeft().getLeft().getLeft().getData().equals(1)) {
            return false;
        }

        if (tree.root.getRight().getLeft() == null || !tree.root.getRight().getLeft().getData().equals(25)) {
            return false;
        }
        if (tree.root.getRight().getRight() == null || !tree.root.getRight().getRight().getData().equals(40)) {
            return false;
        }
    ...
    */
    public boolean test2() {
        ...
        if (tree.root.getRight().getLeft() == null || !tree.root.getRight().getLeft().getData().equals("c")) {
            return false;
        }
